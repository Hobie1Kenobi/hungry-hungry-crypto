...
export const TOY_LOOK = { x: 0.12, y: 0.7, z: -1.12 }
const SHAKE_MS = 120
...
export function ArenaCamera() {
  ...
  useFrame(({ clock }, dt) => {
    ...
    const dist = (ui === 'results' ? TOY_DIST + 1.4 : TOY_DIST) * short * tall * dolly * zoom
    ...
    look.set(TOY_LOOK.x, TOY_LOOK.y, result ? TOY_LOOK.z + 0.06 : TOY_LOOK.z)
    cam.lookAt(look)
