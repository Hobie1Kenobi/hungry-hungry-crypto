...
export function Hopper() {
  ...
  useFrame((_, dt) => {
    ...
    ref.current.rotation.z = shaking ? Math.sin(dumpT * 40) * 0.05 : 0
    const pulse = shaking ? 1 + Math.sin(dumpT * 28) * 0.03 : 1
  ...
  return (
    <group ref={ref} position={[0, 4.15, 0]}>
