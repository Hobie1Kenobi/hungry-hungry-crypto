...
- Playing camera is still a fixed behind-BYTEBITE toy-ad. Lateral shift to x -3.6 (BLOCKMAW / screen-right side of south), y 8.7 z -11.1, look retuned to -0.2 / 0.55 / -1.9, fov 35. Not another pull-back/up. BYTEBITE barrel, deck, and rubber feet sit in the 1280x800 frame with air under the base. CROSS hub recenters. RIPSAW tail leaves the left third. BLOCKMAW and the west CROSS rail occupy the old bottom-right floor wedge. GOLDGRUB / BLOCKMAW stay on screen. All four jaws stay on screen. No per-frame neck-track. No Cycle 9 cyan slab. No Cycle 2 void. No Cycle 7 speck. Not Cycle 13's empty-floor look.
- Results camera drops elevation to 3.2, radius 9.2, fov 35, look-Y 1.4, pond blend 0.5, orbit turn -0.12. Winner is a readable hero center-right of the left card, lower in the frame, still an open-pond overview. Other beasts and CROSS stay readable to the right of the card. Beige wall band is cropped. No crash-zoom. No `setViewOffset` pad. Visual necks still park short (0.94 latch). Winner name stays stacked inside the card.
